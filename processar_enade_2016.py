...
def main():
    ano = 2016
    original_file = "Enade 2016.xlsm"
    raw_file = "temp_2016.xlsm"
    ...
    if 'microdados2016_arq1' in abas_brutas:
        df_arq1 = pd.read_excel(xls_raw, sheet_name='microdados2016_arq1')
    ...
    with pd.ExcelWriter(out_file, engine='openpyxl') as writer:
        ...
        # Processar Aba Enade
        if 'Enade' in abas_brutas:
            df_planilha = pd.read_excel(xls_raw, sheet_name='Enade')
            ...
            print(f"      Aba Enade extraída com sucesso ({len(df_enade)} registros).")
        else:
            print("      Aviso: Aba Enade não encontrada.")
