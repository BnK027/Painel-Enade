...
* **Extração de Notas Oficiais (Atualização):** Após o arquivo ser atualizado pelo usuário com a aba `PLANILHA_ENADE` oficial do Inep (contendo o Conceito Enade e médias de Notas Brutas de FG/CE), refatoramos o `processar_enade_2023.py` para extrair essa aba e isolar apenas os registros correspondentes aos cursos do IFES, substituindo o cálculo sintético das médias por dados oficiais de avaliação.
